...
import priv.hb.sample.sql.gsql.lineage.visitor.TInsertSqlStatementVisitor;
...
/**
 * INSERT语句的statement的类型是 gudusoft.gsqlparser.stmt.TInsertSqlStatement
 *
 * @author hubin
...
public class InsertTest {
    ...
    public void test4() {
        ...
        TInsertSqlStatementVisitor tInsertSqlStatementVisitor = new TInsertSqlStatementVisitor();
        sqlstatements.get(0).accept(tInsertSqlStatementVisitor);
        List<Tuple2<String, String>> partitions = tInsertSqlStatementVisitor.getStaticPartitions();
        System.out.println(partitions);
        System.out.println(tInsertSqlStatementVisitor.getTargetTableName());
    }
    ...
    public void test6() {
        ...
        TInsertSqlStatementVisitor tInsertSqlStatementVisitor = new TInsertSqlStatementVisitor();
        sqlstatements.get(0).accept(tInsertSqlStatementVisitor);
        List<String> partitions = tInsertSqlStatementVisitor.getDynamicPartitions();
        System.out.println(partitions);
        System.out.println(tInsertSqlStatementVisitor.getTargetTableName());
    }
}
