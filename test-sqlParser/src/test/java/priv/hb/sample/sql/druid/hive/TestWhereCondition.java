...
public class TestWhereCondition {
    ...
    public void modifySql1() {
        ...
        SQLExprTableSource tableSource = Utils.cast(queryBlock.getFrom(), SQLExprTableSource.class);
        tableSource.setExpr(SQLUtils.toSQLExpr("crm.ads_crm_shop_recommend_h"));


        SQLBinaryOpExpr where = Utils.cast(queryBlock.getWhere(), SQLBinaryOpExpr.class);
