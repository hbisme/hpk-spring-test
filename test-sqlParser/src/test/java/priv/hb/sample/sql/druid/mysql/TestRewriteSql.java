...
import priv.hb.sample.sql.druid.common.Utils;
...
public class TestRewriteSql {
    ...
    public void modifyWhereExpr() {
        ...
        MySqlSelectQueryBlock queryBlock = Utils.cast(sqlSelectQuery, MySqlSelectQueryBlock.class);
    ...
    public void modifyFromExpr() {
        ...
        SQLExprTableSource source = Utils.cast(from, SQLExprTableSource.class);
    ...
    public void modifyLimit() {
        ...
        SQLSelectQuery sqlSelectQuery = Utils.parseSQLSelectQuery(sql1);
        MySqlSelectQueryBlock queryBlock = Utils.cast(sqlSelectQuery, MySqlSelectQueryBlock.class);
        ...
        SQLSelectQuery sqlSelectQuery2 = Utils.parseSQLSelectQuery(sql2);
        MySqlSelectQueryBlock queryBlock2 = Utils.cast(sqlSelectQuery2, MySqlSelectQueryBlock.class);
        ...
        SQLSelectQuery sqlSelectQuery3 = Utils.parseSQLSelectQuery(sql3);
        MySqlSelectQueryBlock queryBlock3 = Utils.cast(sqlSelectQuery3, MySqlSelectQueryBlock.class);
