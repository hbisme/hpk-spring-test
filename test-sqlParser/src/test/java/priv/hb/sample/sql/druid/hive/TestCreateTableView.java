...
import static priv.hb.sample.sql.druid.common.SqlAnalyze.extractTableFromCreateSql;

/**
 * 测试SQL解析中的CREATE TABLE 和 CREATE VIEW 语句
 * 返回结果是Tuple(输入表List, 输出表)
 *
 * @author hubin
 * @date 2022年09月15日 09:25
 */
public class TestCreateTableView {
    @Test
    public void test1() {
        ...
        Tuple2<List<String>, String> listStringTuple2 = extractTableFromCreateSql(sql);
        System.out.println(listStringTuple2);
    }
